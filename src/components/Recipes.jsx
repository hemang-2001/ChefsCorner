        ...
        <div className='w-full'>
...

            {
                ...
                recipes?.length > 0 ? (
                    ...
                    <>
                        <div className='w-full items-center justify-center flex flex-wrap gap-10 px-0 lg:px-10 py-10'>
                            {
                        ...
                        <div className='flex w-full items-center justify-center py-10'>
                            ...
                            <Button
                                title="Show More"
                                containerStyle="bg-blue-800 text-white px-3 py-1 rounded-full text-sm"
